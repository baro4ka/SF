...
По мере решения последовательных задач были выявлены пропуски данных, выбросы и неоднородность, что мешало использовать данные для обучения качественной модели.
